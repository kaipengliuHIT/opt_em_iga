#!/bin/bash
# Sweep the full-rank operator-Jacobi smoother for pure independent Yee-PML.
# Usage: bash run_pml_smoother_sweep.sh

set -e

REPO=/mnt/f/optemcode/opt_em_iga_repo
MESH=/mnt/f/optemcode/mfem/data/cube-nurbs.mesh
OUTFILE=$REPO/pml_smoother_sweep.csv
...
for W in 1.2 1.5 1.8 2.0 2.3 2.5 2.8 3.0 3.3 3.5; do
    echo "--- edge_yee pure Yee-PML sjac=$W ---"
